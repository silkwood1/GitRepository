...
<nav id="topMenu">
		<ul>
			<li class="topMenuLi"><a class="menuLink" href="">관리</a>
				<ul class="submenu">
					<li><a href="" class="submenuLink">고객 관리</a></li>
					<li><a href="" class="submenuLink">사원 관리</a></li>
					<li><a href="" class="submenuLink">?</a></li>
				</ul></li>
			<li>|</li>
			<li class="topMenuLi"><a class="menuLink" href="">자재</a>
				<ul class="submenu">
					<li><a href="" class="submenuLink">재고 관리</a></li>
					<li><a href="" class="submenuLink">매입</a></li>
					<li><a href="" class="submenuLink">?</a></li>
				</ul></li>
			<li>|</li>
			<li class="topMenuLi"><a class="menuLink" href="">회계</a>
				<ul class="submenu">
					<li><a href="" class="submenuLink">판매 현황</a></li>
					<li><a href="" class="submenuLink">지출</a></li>
					<li><a href="" class="submenuLink">?</a></li>
				</ul></li>
			<li>|</li>
			<li class="topMenuLi"><a class="menuLink" href="">4번 메뉴</a></li>
			<li>|</li>
			<li class="topMenuLi"><a class="menuLink" href="">5번 메뉴</a></li>
		</ul>
	</nav>
</body>
</html>